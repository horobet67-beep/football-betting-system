#!/usr/bin/env python3
"""
Season-by-Season Validation for Romanian Liga I
...
from simple_predict_range import SimpleRomanianPredictor
    ...
    for _, match in test_data.iterrows():
        ...
        for rec in recommendations:
            ...
            if outcome:
                ...
                estimated_odds = predictor.get_expected_odds(rec.pattern_name)
...
def main():
    print("="*80)
    print("ROMANIAN LIGA I SEASON-BY-SEASON VALIDATION")
    ...
    # Define seasons (Romanian Liga I typically runs July-May)
    seasons = [
        {
            'label': '2022-23',
