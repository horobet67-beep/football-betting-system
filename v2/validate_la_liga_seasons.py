#!/usr/bin/env python3
"""
Season-by-Season Validation for La Liga
Tests if system works consistently across different Spanish seasons
"""
...
def main():
    print("="*80)
    print("LA LIGA SEASON-BY-SEASON VALIDATION")
    print("Testing system consistency across different Spanish seasons")
    print("="*80)
    print()
    ...
    # Define seasons (La Liga typically runs Aug-May)
    seasons = [
        {
            'label': '2022-23',
